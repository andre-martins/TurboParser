...
namespace TurboParserInterface {
  ...
  TurboMorphologicalTaggerWorker::TurboMorphologicalTaggerWorker() {
    ...
    morphological_tagger_pipe_ = new MorphologicalPipe(morphological_tagger_options_);
  ...
  void TurboMorphologicalTaggerWorker::LoadMorphologicalTaggerModel(const std::string &file_model) {
