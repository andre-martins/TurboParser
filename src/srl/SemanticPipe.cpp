...
void SemanticPipe::PreprocessData() {
  ...
  static_cast<SemanticDictionary*>(dictionary_)->
    CreateRoleDictionary(GetSemanticReader());
}
...
void SemanticPipe::MakePartsBasic(Instance *instance,
  ...
  SemanticDictionary *dependency_dictionary = GetSemanticDictionary();
...
void SemanticPipe::MakePartsGrandSiblings(Instance *instance,
                                            Parts *parts,
                                            vector<double> *gold_outputs) {
  SemanticInstanceNumeric *sentence =
    static_cast<SemanticInstanceNumeric*>(instance);
...
void SemanticPipe::MakePartsTriSiblings(Instance *instance,
                                          Parts *parts,
                                          vector<double> *gold_outputs) {
  SemanticInstanceNumeric *sentence =
    static_cast<SemanticInstanceNumeric*>(instance);
...
void SemanticPipe::MakePartsNonprojectiveArcs(Instance *instance,
                                                Parts *parts,
                                                vector<double> *gold_outputs) {
  SemanticInstanceNumeric *sentence = 
    static_cast<SemanticInstanceNumeric*>(instance);
...
void SemanticPipe::MakePartsDirectedPaths(Instance *instance,
                                            Parts *parts,
                                            vector<double> *gold_outputs) {
  SemanticInstanceNumeric *sentence = 
    static_cast<SemanticInstanceNumeric*>(instance);
...
void SemanticPipe::MakePartsHeadBigrams(Instance *instance,
                                          Parts *parts,
                                          vector<double> *gold_outputs) {
  SemanticInstanceNumeric *sentence = 
    static_cast<SemanticInstanceNumeric*>(instance);
...
bool SemanticPipe::IsProjectiveArc(const vector<int> &heads,
                                     int par,
                                     int ch) {
  int i0 = par;
  int j0 = ch;
...
void SemanticPipe::MakeSelectedFeatures(Instance *instance,
  ...
  SemanticInstanceNumeric *sentence =
    static_cast<SemanticInstanceNumeric*>(instance);
  SemanticParts *dependency_parts = static_cast<SemanticParts*>(parts);
  SemanticFeatures *dependency_features =
  ...
  for (int r = offset; r < offset + size; ++r) {
    if (!selected_parts[r]) continue;
    SemanticPartArc *arc =
      static_cast<SemanticPartArc*>((*dependency_parts)[r]);
    CHECK_GE(arc->head(), 0);
    if (pruner) {
  ...
  for (int r = offset; r < offset + size; ++r) {
    if (!selected_parts[r]) continue;
    SemanticPartSibl *part =
      static_cast<SemanticPartSibl*>((*dependency_parts)[r]);
  ...
  for (int r = offset; r < offset + size; ++r) {
    if (!selected_parts[r]) continue;
    SemanticPartNonproj *part =
      static_cast<SemanticPartNonproj*>((*dependency_parts)[r]);
  ...
  for (int r = offset; r < offset + size; ++r) {
    if (!selected_parts[r]) continue;
    SemanticPartPath *part =
      static_cast<SemanticPartPath*>((*dependency_parts)[r]);
  ...
  for (int r = offset; r < offset + size; ++r) {
    if (!selected_parts[r]) continue;
    SemanticPartHeadBigram *part =
      static_cast<SemanticPartHeadBigram*>((*dependency_parts)[r]);
...
void SemanticPipe::LabelInstance(Parts *parts, const vector<double> &output,
                   Instance *instance) {
  SemanticParts *dependency_parts = static_cast<SemanticParts*>(parts);
  SemanticInstance *dependency_instance =
